...
class MethodChannelAbrevvaBlePlatform extends AbrevvaBlePlatform {
  ...
  @override
  Future<void> signalize(String deviceId) async {
  ...
  Future<void> startNotifications(
    ...
    final key =
        "notification|${deviceId}|${service}|${characteristic}".toLowerCase();
  ...
  @override
  Future<void> stopNotifications(String deviceId, String service,
      String characteristic, int timeout) async {
