...
class MethodChannelCodingStation extends AbrevvaCodingStationPlatform {
  ...
  Future<void> register(
      String url, String clientId, String username, String password) async {
    ...
    await _methodChannel.invokeMethod<void>('register', map);
  }
  ...
  Future<void> write() async {
    await _methodChannel.invokeMethod<void>('write');
  }
...
class MethodChannelAbrevvaCrypto extends AbrevvaCryptoPlatform {
  ...
  Future<KeyPairResult> generateKeyPair() async {
    ...
    if (result == null ||
      ...
      throw PlatformException(
          code: "generateKeyPair(): error retrieving KeyPairResult");
    }
  ...
  Future<EncryptResult> encrypt(
    ...
    if (result == null ||
        ...
        result["authTag"] == null) {
      throw PlatformException(
          code: "encrypt(): error retrieving EncryptResult");
    }
  ...
  Future<DecryptResult> decrypt(
    ...
    final result =
        await _methodChannel.invokeMethod<Map<dynamic, dynamic>?>('decrypt', {
      'key': key,
      'iv': iv,
      'adata': adata,
      'ct': ct,
    ...
    if (result == null ||
        ...
        result["authOk"] == null) {
      throw PlatformException(
          code: "decrypt(): error retrieving DecryptResult");
    }
  ...
  Future<bool> encryptFile(
    ...
    final result = await _methodChannel
        .invokeMethod<Map<dynamic, dynamic>>('encryptFile', {
      'sharedSecret': sharedSecret,
      'ptPath': ptPath,
      'ctPath': ctPath,
    });
    if (result == null || result["opOk"] == null) {
  ...
  Future<StringResult> computeSharedSecret(
    ...
    if (result == null || result["sharedSecret"] == null) {
      throw PlatformException(
          code: "computeSharedSecret(): error retrieving sharedSecret");
    }
  ...
  Future<bool> decryptFile(
    ...
    final result = await _methodChannel
        .invokeMethod<Map<dynamic, dynamic>>('decryptFile', {
      'sharedSecret': sharedSecret,
      'ctPath': ctPath,
      'ptPath': ptPath,
    });
  ...
  Future<StringResult> derive(
    ...
    final result =
        await _methodChannel.invokeMethod<Map<dynamic, dynamic>>('derive', {
      'key': key,
      'salt': salt,
      'info': info,
      'length': length,
  ...
  @override
  Future<ED25519PublicKeyResult> computeED25519PublicKey(
      String privateKey) async {
    final result = await _methodChannel
        .invokeMethod<Map<dynamic, dynamic>>('computeED25519PublicKey', {
      'privateKey': privateKey,
    });
    if (result == null || result["publicKey"] == null) {
      throw PlatformException(
          code: "computeED25519PublicKey(): error computing key");
    }
  ...
  Future<SignResult> sign(String privateKey, String data) async {
    final result =
        await _methodChannel.invokeMethod<Map<dynamic, dynamic>>('sign', {
      'privateKey': privateKey,
      'data': data,
    });
...
class MethodChannelAbrevvaBlePlatform extends AbrevvaBlePlatform {
  ...
  set connectEventChannel(EventChannel channel) =>
      _connectEventChannel = channel;

  var _startScanEventChannel = const EventChannel('startScanEventChannel');
  set startScanEventChannel(EventChannel channel) =>
      _startScanEventChannel = channel;

  var _startNotificationsEventChannel =
      const EventChannel('startNotificationsEventChannel');
  set startNotificationsEventChannel(EventChannel channel) =>
      _startNotificationsEventChannel = channel;

  var _startEnabledNotificationsEventChannel =
      const EventChannel('startEnabledNotificationsEventChannel');
  set startEnabledNotificationsEventChannel(EventChannel channel) =>
      _startEnabledNotificationsEventChannel = channel;

  @override
  Future<void> initialize(bool androidNeverForLocation) async {
    if (Platform.isAndroid) {
      List<Permission> permissions = [];
      final eval =
          await _methodChannel.invokeMethod<bool?>('evaluateSdkVersion') ??
              false;
      if (eval) {
  ...
  Future<void> startEnabledNotifications(
    ...
    _enabledNotificationStream = _startEnabledNotificationsEventChannel
        .receiveBroadcastStream()
        .listen((event) {
      if (event == null || event["value"] == null) {
        throw PlatformException(
            code: "startEnabledNotifications(): error retrieving value");
      }
  ...
  Future<void> stopEnabledNotifications() async {
    ...
    return await _methodChannel.invokeMethod<void>('stopEnabledNotifications');
  }

  @override
  Future<void> openLocationSettings() async {
    return await _methodChannel.invokeMethod<void>('openLocationSettings');
  }

  @override
  Future<void> openBluetoothSettings() async {
    return await _methodChannel.invokeMethod<void>('openBluetoothSettings');
  }

  @override
  Future<void> openAppSettings() async {
    return await _methodChannel.invokeMethod<void>('openAppSettings');
  }
  ...
  ComponentType _getComponentType(String? type) {
    return type == null
        ...
        : ComponentType.values.byName(type);
  }

  BleDevice _mapScanResult(Map<Object?, Object?> data) {
    Map<Object?, Object?> advertisementData =
        data["advertisementData"] as Map<Object?, Object?>;
    Map<Object?, Object?> mfData =
        advertisementData["manufacturerData"] as Map<Object?, Object?>;
    final mf = BleDeviceManufacturerData(
      ...
      batteryStatus:
          _getBatteryStatusHelper(mfData["batteryStatus"] as String?),
  ...
  @override
  Future<List<Uint8>> read(String deviceId, String service,
      String characteristic, int timeout) async {
    final result =
        await _methodChannel.invokeMethod<Map<dynamic, dynamic>?>('read', {
      'deviceId': deviceId,
      'service': service,
  ...
  Future<void> write(String deviceId, String service, String characteristic,
      String value, int timeout) async {
  ...
  Future<DisengageResult> disengageWithXvnResponse(
      ...
      bool isPermanentRelease) async {
    final result = await _methodChannel
        .invokeMethod<Map<dynamic, dynamic>?>('disengageWithXvnResponse', {
      'deviceId': deviceId,
      'mobileId': mobileId,
      'mobileDeviceKey': mobileDeviceKey,
      'mobileGroupId': mobileGroupId,
    ...
    return DisengageResult(
      status: DisengageStatusType.values
          .byName(_toCamelCase(result["status"] as String)),
  ...
  Future<bool> startNotifications(
    ...
    final key =
        "notification|$deviceId|${service.toLowerCase()}|${characteristic.toLowerCase()}";
    ...
    final result = await _methodChannel
        .invokeMethod<Map<dynamic, dynamic>?>('startNotifications', {
      'deviceId': deviceId,
      'service': service,
      'characteristic': characteristic,
      'timeout': timeout,
    ...
    if (result == null || result["value"] == null) {
      throw PlatformException(
          code: "startNotifications(): error retrieving value");
    }
    return result["value"];
  }

  @override
  Future<bool> stopNotifications(String deviceId, String service,
      String characteristic, int timeout) async {
    final key =
        "notification|$deviceId|${service.toLowerCase()}|${characteristic.toLowerCase()}";
    _notificationStreams[key]?.cancel();
    ...
    if (result == null || result["value"] == null) {
      throw PlatformException(
          code: "stopNotifications(): error retrieving value");
    }
    return result["value"];
  }
  ...
  Future<bool> signalize(String deviceId) async {
    final result = await _methodChannel
        .invokeMethod<bool?>('signalize', {'deviceId': deviceId});
    if (result == null) {
      throw PlatformException(
          code: "stopNotifications(): error retrieving value");
    }
